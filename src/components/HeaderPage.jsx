    ...
    <header className="bg-neutral-50 w-full h-auto">
      <nav className="flex flex-col md:flex-row justify-between items-center h-20 px-6">
        ...
        <ul className="flex flex-col md:flex-row space-y-2 md:space-y-0 space-x-0 md:space-x-6 mt-4 md:mt-0 ml-0 md:ml-20 text-center md:text-left">
          <li>
            <a href="/" className="font-inter font-normal text-base md:text-lg text-colorLinkHeader">ACCUEIL</a>
          </li>
          <li>
        ...
        <div className="flex space-x-2 mt-4 md:mt-0">
          <div className="bg-bcButtonHeader w-36 h-10 text-center rounded-md">
            <button className="w-full h-full font-inter text-sm font-normal text-colorButtonHeader">Se connecter</button>
          </div>
          <div className="bg-colorLinkHeader w-36 h-10 text-center rounded-md">
